...
load(here('data','trig_d38.RData')) #'trig_d29.RData'

load(here('data','sample_window.RData')) #'sample_window_d29.RData'
...
save(mean_hex_clim_df, scaled_hex_clim_df, file=here('data','Krapp_enviro_variables.RData')) #'Krapp_enviro_variables_d29.RData'
