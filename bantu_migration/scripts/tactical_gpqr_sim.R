...
sampling_win  <- sampling_win[order(raster::area(sampling_win), decreasing=TRUE)[1:2]]
...
true_param$beta1 <- 0.15 #reciprocal of dispersal rate ##TODO: This should be increase to 0.3, but other parameters need changing such that theta (out.df$theta in gpqrSim()) remains positive
