...
#-------------------------------------------------------------------------------
## Data Setup ----
load(here('data', 'eastc14_d64.RData')) #East and Southern Africa
load(here('data','trig_d64.RData')) #nodes and edges between hex area centroids
...
save(out_icar_model_a, 
     ...
     ess_icar_model_a, 
     agg_icar_model_a, 
     file=here('output','ICAR_model_a_d64.RData'))
save(out_icar_model_b, 
     rhat_icar_model_b, 
     ess_icar_model_b, 
     agg_icar_model_b, 
     file=here('output','ICAR_model_b_d64.RData'))
