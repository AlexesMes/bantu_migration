...
load(here('data', 'c14_d72.RData')) #sub-Saharan Africa
load(here('data','trig_cont_d72.RData'))
...
save(out_icar_model_a, 
     ...
     ess_icar_model_a, 
     agg_icar_model_a, 
     file=here('output','ICAR_model_a_cont_d72.RData')) 
save(out_icar_model_b, 
     rhat_icar_model_b, 
     ess_icar_model_b, 
     agg_icar_model_b, 
     file=here('output','ICAR_model_b_cont_d72.RData')) 
