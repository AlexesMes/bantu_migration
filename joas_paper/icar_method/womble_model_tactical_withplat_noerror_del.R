...
#-------------------------------------------------------------------------------
## Data Setup ----
load(here('data', 'tactical_sim_icar_withinplat_noerror.RData')) #tactical_sim_icar_withoutplat.Rdata
...
# 
# theta_init <- sim_df$cra #initialize theta parameter
# 
# #Constants
...
#      ess_womble_model, 
#      agg_womble_model, 
#      file=here('output','Womblemodel_tactical_withplat_noerrors.RData'))
# 
